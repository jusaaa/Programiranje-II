...
public:
    ...
    friend ostream& operator<< (ostream& COUT, const Predmet& obj) {
        ...
        {
            COUT << "Dana: " << *obj._ocjene->getElement1(i) << " ocjena " << obj._ocjene->getElement2(i) << endl;
        }
...
public:
    ...
    friend ostream& operator<< (ostream& COUT, const Uspjeh& obj) {
        ...
        {
            COUT << *obj._polozeniPredmeti.getElement1(i) << " " << obj._polozeniPredmeti.getElement2(i) << endl << endl;
        }
        return COUT;
    }
};
...
bool ValidirajBrojTelefona(string brojTelefona) {
    return regex_match(brojTelefona, regex("\\+[0-9]{2,3}0?[0-9]{2}[0-9]{2,3}[ -]?[0-9]{2,3}"));
}
class Kandidat {
    char* _imePrezime;
    string _emailAdresa;
