...
public:
	...
	bool DodajKomentarKarakteristike(Karakteristike karakteristika, const char* komentar) {
...
public:
	...
	Kupac(const Kupac& obj) :Osoba(obj), _emailAdresa(GetNizKaraktera(obj._emailAdresa)), _kupovine(new Rjecnik<float, ZadovoljstvoKupca>(*obj._kupovine)) {
	}
